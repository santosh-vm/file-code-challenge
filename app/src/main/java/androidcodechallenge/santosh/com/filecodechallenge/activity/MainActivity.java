package androidcodechallenge.santosh.com.filecodechallenge.activity;
...
import androidcodechallenge.santosh.com.filecodechallenge.listerners.SDCardControllerListener;
...
public class MainActivity extends BaseActivity implements View.OnClickListener, SDCardControllerListener {
    ...
    @BindView(R.id.progress_view_root_layout)
    View progressViewRoot;

    @BindView(R.id.progress_message)
    TextView progressMessageTextView;

    @BindView(R.id.details_root_layout)
    View detailsRootView;

    @BindView(R.id.average_file_size_textview)
    TextView averageFileSizeTextView;

    @BindView(R.id.get_top_file_list)
    LinearLayout topFileSizeLinearLayout;

    @BindView(R.id.get_top_file_extension_list)
    LinearLayout frequentFileExtensionLinearLayout;
